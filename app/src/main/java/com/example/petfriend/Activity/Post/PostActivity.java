...
public class PostActivity extends AppCompatActivity {
    ...
    private void uploadImage(){
        ...
        progressDialog.setMessage("게시물 등록 중입니다.");
        progressDialog.show();

        if(imageUir != null){
            final StorageReference filerefrence = storageReference.child(System.currentTimeMillis()
            +"."+getFileExtension(imageUir));

            uploadTask = filerefrence.putFile(imageUir);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK){
            ...
            imageUir = result.getUri();

            image_added.setImageURI(imageUir);
        }else{
